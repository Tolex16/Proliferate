...
public class SecurityConfiguration   {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception{
        http.csrf(AbstractHttpConfigurer::disable)
                .authorizeHttpRequests(request -> request.requestMatchers("/api/v1/auth/studentPersonalDetails","/api/v1/authorize/tutorPersonalDetails","/api/v1/auth/terms-and-conditions","/api/v1/auth/login","/api/v1/forgot-password/**","/api/v1/change-password","/api/v1/authorize/login-tutor","/ws/**","/api/v1/call/**" ,"/api/v1/auth/check-username/{username}","/api/v1/authorize/check-mail/{email}","/api/v1/auth/logout")
                        .permitAll()
